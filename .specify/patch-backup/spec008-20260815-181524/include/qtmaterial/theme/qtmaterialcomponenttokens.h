...
QTMATERIAL3_THEME_MODEL_EXPORT QString componentIdToString(ComponentId id);
QTMATERIAL3_THEME_MODEL_EXPORT bool componentIdFromString(const QString& name, ComponentId* outId);

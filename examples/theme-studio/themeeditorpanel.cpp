...
static QString chipStyle(const QColor& color)
{
    ...
    , m_exportButton(new QPushButton(tr("Export JSON"), this))
{
    ...
    connect(m_modeCombo,
            ...
            this,
            [this](int index) {
                const auto mode = static_cast<ThemeMode>(m_modeCombo->itemData(index).toInt());
    ...
    connect(m_contrastCombo,
            ...
            [this](int index) {
                ...
                m_controller->setContrast(contrast);
            });
    ...
    connect(m_applyButton, &QPushButton::clicked, m_controller, &ThemeStudioController::applyPending);
    connect(m_resetButton, &QPushButton::clicked, m_controller, &ThemeStudioController::resetToDefaults);

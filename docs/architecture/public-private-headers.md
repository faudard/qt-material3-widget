...
The source and CMake package contracts require:
...
Real Qt5/Qt6 shared/static install and consumer executions remain required evidence and
complement the static contract.

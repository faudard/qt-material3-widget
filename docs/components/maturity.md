...
| `data.pagination` | Pagination | `usable` | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | Keep native Qt behavior and cross-platform certification green through 1.0. |
...
| `data.tree-view` | Tree View | `usable` | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | Keep native Qt behavior and cross-platform certification green through 1.0. |
...
| ID | Component | Status | API | Render | States | A11y | Keys | HiDPI | RTL | Tests | Example | Docs | Notes |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `layout.split-view` | Split View | `usable` | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | Keep native Qt behavior and cross-platform certification green through 1.0. |

### Navigation

| ID | Component | Status | API | Render | States | A11y | Keys | HiDPI | RTL | Tests | Example | Docs | Notes |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `navigation.breadcrumb` | Breadcrumb | `usable` | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | Keep native Qt behavior and cross-platform certification green through 1.0. |
| `navigation.command-palette` | Command Palette | `usable` | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | 3 | Keep native Qt behavior and cross-platform certification green through 1.0. |
...
| Pagination | Keep native Qt behavior and cross-platform certification green through 1.0. |
| Table | Add Table reference-model, accessibility, RTL and HiDPI evidence before raising maturity axes. |
| Tree View | Keep native Qt behavior and cross-platform certification green through 1.0. |
...
| Split View | Keep native Qt behavior and cross-platform certification green through 1.0. |
| Breadcrumb | Keep native Qt behavior and cross-platform certification green through 1.0. |
| Command Palette | Keep native Qt behavior and cross-platform certification green through 1.0. |

    ...
    : public QtMaterialWidget
{
    ...
    Q_PROPERTY(
        int leadingInset
        READ leadingInset
        WRITE setLeadingInset
        NOTIFY leadingInsetChanged)
    Q_PROPERTY(
        int trailingInset
        READ trailingInset
        WRITE setTrailingInset
    ...
    Q_PROPERTY(
        ...
        READ isDecorative
        WRITE setDecorative
        NOTIFY decorativeChanged)
    Q_PROPERTY(
        QString accessibilityLabel
        READ accessibilityLabel
        WRITE setAccessibilityLabel
        NOTIFY accessibilityLabelChanged)

public:
    explicit QtMaterialDivider(
    ...
    static QtMaterialDivider* horizontal(
        QWidget* parent = nullptr);
    static QtMaterialDivider* vertical(
        QWidget* parent = nullptr);
...
Q_SIGNALS:
    ...
    void accessibilityLabelChanged(
        const QString& label);

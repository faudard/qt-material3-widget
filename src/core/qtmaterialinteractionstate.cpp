...
void QtMaterialInteractionState::setPressed(bool value) noexcept { m_pressed = value; }
void QtMaterialInteractionState::setChecked(bool value) noexcept { m_checked = value; }
void QtMaterialInteractionState::setCheckable(bool value) noexcept { m_checkable = value; }
void QtMaterialInteractionState::setEnabled(bool value) noexcept { m_enabled = value; }

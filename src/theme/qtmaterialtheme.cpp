...
const IconSizeTokens& Theme::iconSizes() const noexcept { return m_iconSizes; }
IconSizeTokens& Theme::iconSizes() noexcept { return m_iconSizes; }

const ComponentTokenOverrides& Theme::componentOverrides() const noexcept { return m_componentOverrides; }
ComponentTokenOverrides& Theme::componentOverrides() noexcept { return m_componentOverrides; }

...
void tst_ShadowRenderer::paintsIntoImage()
{
    ...
    QtMaterial::QtMaterialShadowRenderer::paintRoundedShadow(
        &painter,
        QRectF(16, 16, 80, 48),
        16.0,
        QColor(0, 0, 0, 80),
...
void tst_ShadowRenderer::paintsAtHighDpi()
{
    QImage image(256, 192, QImage::Format_ARGB32_Premultiplied);

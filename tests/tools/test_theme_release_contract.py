...
class ThemeReleaseContractTests(unittest.TestCase):
    def test_current_checkout_satisfies_theme_release_contract(self):
        self.assertEqual(MODULE.validate(ROOT, "0.6.0"), [])
    ...
    def test_project_version_parser(self):
        text = "project(qt-material3-widgets VERSION 0.6.0 LANGUAGES CXX)"
        self.assertEqual(MODULE.project_version(text), "0.6.0")

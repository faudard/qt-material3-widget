...
- [x] **T001 [REG-FR-001/002]** Add versioned schema v1 without changing registry array format.
- [x] **T002 [REG-FR-003]** Make governance checker import/reuse the existing generator validator.
